...
- (id)initWithName:(NSString *)n{
    ...
    if(self){
        ...
        developer_meishi.history = [NSString stringWithFormat:@"京都の某大学にて大学生活を過ごす。学生の間は主にポケモンをして過ごし、4年で卒業。その後、大学院に行き、名刺バトラーを開発する。しかし、自分が研究に向いていないことに気づき、%@、%@に転職。転職1年目のかけだし。",developer_meishi.date_string ,[developer_meishi getJobString]];
        ...
        developer_meishi_akino.history = [NSString stringWithFormat:@"京都の某大学にて大学生活を過ごす。学生の間は主に本を読んで過ごし、4年で卒業。その後、名刺バトラーを企画し、開発する。そして、%@、%@に転職。転職1年目のかけだし。", developer_meishi_akino.date_string, [developer_meishi_akino getJobString]];
